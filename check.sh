...
python hw2_base.py --project 'hw2' --exp_type 'base' --output_type 'ddtheta' --predict_dim 1 --check --lrate 0.0001 --activation_hidden 'elu' --activation_out 'linear' --hidden 500 250 125 75 36 17 --epochs 100 -vv
